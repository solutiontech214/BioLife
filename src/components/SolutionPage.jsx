...
export const ProductDetails = () => (
  <section className="bg-sky-50 py-24 px-8 text-center">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
      ...
      <div className="bg-white rounded-xl p-6 shadow border border-sky-100">
        <img src="../Images/d.jpg" className="w-60 h-52" />
        <h3 className="text-xl font-semibold text-sky-500">
          Hands-Free Independence
        </h3>
        <p className="text-slate-600">
          No need to Extra person for support,giving them true mobility and dignity on their own terms.
        </p>
      </div>
      <div className="bg-white rounded-xl p-6 shadow border border-sky-100">
        <img src="../Images/design.jpg" className="w-60 h-52" />
        <h3 className="text-xl font-semibold text-sky-500">

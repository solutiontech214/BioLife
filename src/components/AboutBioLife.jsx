...
const AboutBioLife = () => {
  ...
  return (
    <section className="relative w-full py-24 px-10 bg-gradient-to-br from-[#050505] via-[#0a0a0a] to-[#101010] overflow-hidden text-gray-200">
      {/* Background glow */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_40%,rgba(34,197,94,0.08),transparent_60%)] blur-3xl animate-pulse"></div>
      ...
      <motion.h2
        ...
        whileInView="show"
        viewport={{ once: true }}
        className="text-5xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-emerald-500 to-green-600 text-center mb-10 drop-shadow-[0_0_25px_rgba(34,197,94,0.3)]"
      >
      ...
      <motion.p
        ...
        whileInView="show"
        viewport={{ once: true }}
        className="max-w-4xl mx-auto text-center text-lg text-gray-400 leading-relaxed mb-12"
      >
        <span className="text-green-400 font-semibold">Muscular Dystrophy (MD)</span> 
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-6xl mx-auto relative z-10">
        {[
          {
            icon: <HeartPulse className="w-9 h-9 text-green-400" />,
          ...
          {
            icon: <Brain className="w-9 h-9 text-green-400" />,
          ...
          >
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <h3 className="text-2xl font-bold text-green-400">{info.title}</h3>
      ...
      <motion.p
        ...
        whileInView="show"
        viewport={{ once: true }}
        className="mt-20 text-center text-gray-400 italic tracking-wide max-w-3xl mx-auto"
      >
